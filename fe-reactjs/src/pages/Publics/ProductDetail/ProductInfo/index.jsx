        ...
        <div className={styles.product__detail_info}>
          ...
          <div className="row gx-5">
            ...
            <div className="col-md-6">
              ...
              <div className={styles.prod_prop}>
                <img className={styles.prod_prop__icon} src={buyIcon} alt="" />
                <div>
                  <h4 className={styles.prod_prop__title}>Delivery</h4>
                  <p className={styles.prod_prop__desc}>From $6 for 1-3 days</p>
                </div>
              </div>
              <div className={styles.prod_prop}>
                <img className={styles.prod_prop__icon} src={bagIcon} alt="" />
                <div>
